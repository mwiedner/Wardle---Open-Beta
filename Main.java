...
public static final String ANSI_YELLOW = "\033[0;93m";
    ...
    public static void main(String[] args) {
      ...
      God Lancelot = new God("Lancelot", "Assassin", "Jungle", "Physical", "Melee", "Arthurian", "Europe", 121);
        ...
        // System.out.println("Random god ID: " + randomize);
        
        // System.out.println("Yesterday's Date ID:" + yesterday);
        // System.out.println("Today's god is: " + Wordle.getName());
        ...
        System.out.println("You have 5 guesses to figure out the random god. After each guess, you will receive feedback. If a result is green, then it is correct. If it is yellow, then that means it is close, but not correct.");
        System.out.println("A yellow pantheon indicates that the pantheon of your guess is from the same continent as the god. A yellow release number indicates that the guess is within 10 releases, and the arrow will point towards if the god is higher or lower in release than your guess.");
        System.out.println("The feedback takes the following form: Class / Conquest Role / Power Type / Attack Type / Pantheon / Release Order");
        System.out.println("");
        System.out.println("");
        System.out.println("Before we begin, here is a list of clarifications: ");
        System.out.println("Cabrakan is a Jungle");
        System.out.println("Sol is an ADC");
        System.out.println("Chronos is a Mid");
        System.out.println("Sobek is a Support");
        System.out.println("Aphrodite is a Mid");
        System.out.println("Freya is an ADC");
        System.out.println("Erlang Shen is a Jungle");
        System.out.println("Artio is a Solo");
        System.out.println("Cerberus is a Solo");
        System.out.println("Olorun is an ADC");
        System.out.println("Gilgamesh is a Solo");
        System.out.println("");
        System.out.println("");
        System.out.println("This version of Wardle supports 3 separate gamemodes: ");
        System.out.println();
        System.out.println("1. Main // This version of Wardle replicates the daily random solution format of Wordle. The solution changes every day at midnight and is consistent for all players across all devices. If you are running Wardle via Repl.it, the god will change at 8PM EST.");
        System.out.println("");
        System.out.println("2. RNG // This version of Wardle generates a random solution each time you play.");
        System.out.println("");
        System.out.println("3. Archives // This version of Wardle allows you to input a date and play the Wardle for that day.");
        System.out.println("");
        System.out.println("");
        System.out.println("Which version of Wardle would you like to play? Input the number corresponding to the version:");
        ...
        while (versioning) {
        	...
        	if (input == 1) {
        		...
        		versioning = false;
        		play(GodPool.get(rng.nextInt(119)), GodPool);
        	}
        	else if (input == 3) {
        		versioning = false;
        		System.out.println("Enter the date of the archive in the format YYMMDD:");
    			System.out.println("For example, April 20, 2022 would be 220420");
    			
    			boolean arching = true;
    			while (arching) {
    				...
    				if (inp > 991231 || inp < 0101 || inp > date) {
    					goodDate = false;
    				}
    				else if (inp % 10000 > 1231 || inp % 100 > 31) {
    					goodDate = false;
    				}
    				
    				if (goodDate) {
    					play(GodPool.get((int)Math.floor(randomGenerator(inp) * 1000000 * 100000 % 118)), GodPool);
              arching = false;
    				}
    				else {
    				...
    				if (inp > date) {
    					System.out.println("No cheating! You cannot play a game for a future date!");
    				}
    			}
        	}
        	else {
